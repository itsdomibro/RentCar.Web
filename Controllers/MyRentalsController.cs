...
using RentCar.Web.ViewModels.MyRental;
...
namespace RentCar.Web.Controllers
{
    public class MyRentalsController : Controller
    {
        ...
        public MyRentalsController(AppDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(int pageNumber = 1, int pageSize = 10)
        {
            ...
            var vm = new MyRentalIndexViewModel { 
        ...
        public async Task<IActionResult> Create(Guid id)
        {
            ...
            var vm = new MyRentalCreateViewModel {
                CarId = car.CarId,
                Name = car.Name,
                Model = car.Model,
        ...
        public async Task<IActionResult> Create(MyRentalCreateViewModel vm)
        {
